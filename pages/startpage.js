...
const StartPage = (props) => {
    return (
        <div className={styles.home_container}>
            ...
            {/* Header*/}
            <div className={styles.home_header} id="header">
                <header
                    data-thq="thq-navbar"
                    className={`${styles.home_navbar_interactive} navbarContainer`}
                >
                    <img className={styles.header_logo} src="/images/header_logo.png" alt="QUIZIFY"></img>
                    {/* <span className={styles.logo}>QUIZIFY</span> */}
                    <div data-thq="thq-navbar-nav" className={styles.home_desktop_menu}>
                        <nav className={styles.home_links}>
                            <a href="#hero"> Home </a>
                        ...
                        <div className={styles.home_buttons}>
                            <button className={`${styles.home_login} buttonFlat`}>
                                <a href="/login">Login</a>
                            </button>
                            <button className={`buttonFilled ${styles.home_register}`}>
                                <a href="/register">Register</a>
                            </button>
                        </div>
                    </div>
                    {/* Mobile BS. Ignored for now. Might even remove it */}
                    <div data-thq="thq-burger-menu" className={styles.home_burger_menu}>
                    ...
                    <div
                        ...
                        className={`${styles.home_mobile_menu1} mobileMenu`}
                    >
                        <div className={styles.home_nav}>
                            <div className={styles.home_top}>
                                <span className={styles.logo}>QUIZIFY</span>
                                <div data-thq="thq-close-menu" className={styles.home_close_menu}>
                                    <svg
                                        viewBox="0 0 1024 1024"
                                        className={`${styles.home_icon02} socialIcons`}
                                    >
                                        <path d="M810 274l-238 238 238 238-60 60-238-238-238 238-60-60 238-238-238-238 60-60 238 238 238-238z"></path>
                                    </svg>
                                </div>
                            </div>
                            <nav className={styles.home_links1}>
                                <span className={`${styles.home_nav121} bodySmall`}>Home</span>
                                <span className={`${styles.home_nav22} bodySmall`}>Create Quiz</span>
                                <span className={`${styles.home_nav32} bodySmall`}>Explore Quizzes</span>
                                <span className={`${styles.home_nav42} bodySmall`}>Sign Up</span>
                                <span className={`${styles.home_nav523} bodySmall`}>Login</span>
                            </nav>
                            <div className={styles.home_buttons1}>
                        ...
                        <div>
                            <svg
                                ...
                                className={`${styles.home_icon04} socialIcons`}
                            >
                            ...
                            <svg
                                ...
                                className={`${styles.home_icon06} socialIcons`}
                            >
                            ...
                            <svg
                                ...
                                className={`${styles.home_icon08} socialIcons`}
                            >
            ...
            {/* Hero*/}
            <div className={styles.home_hero} id="hero">
                <div className={`${styles.home_hero1} heroContainer`}>
                    <div className={styles.home_container1}>
                        ...
                        <div className={styles.home_container2}>
                            <div className={styles.home_container3}>
                                <div className={styles.home_container4}>
                                    <span className={`${styles.home_hero_sub_heading} bodyLarge`}>
                                        <span>
                                    ...
                                    <div className={styles.home_btn_group}>
                                        ...
                                        <a href="/create">
                                            <button className={`${styles.home_hero_button2} buttonFlat`} id="register">
                                                Create a new quiz
                                            </button>
                                        </a>
                                    </div>
            ...
            <div className={styles.home_features}>
                <div className="featuresContainer">
                    <div className={styles.home_features1}>
                        <div className={styles.home_container5}>
                            <span className="overline" id="features">
                                <span>Features</span>
                                <br></br>
                            </span>
                            <h2 className={`${styles.home_features_heading} heading2`}>
                                Unlock Exciting Features
                            </h2>
                            <span className={`${styles.home_features_sub_heading} bodyLarge`}>
                                <span>
                        ...
                        <div className={styles.home_container6}>
                            <FeatureCard
            ...
            {/* Banner*/}
            <div className={styles.home_banner} id="about">
                <div className={`${styles.home_banner1} bannerContainer`}>
                    <h1 className={`${styles.home_banner_heading} heading2`}>
                        Why Choose Our Quiz Hosting Platform?
                    </h1>
                    <span className={`${styles.home_banner_sub_heading} bodySmall`} >
                        <span>
            ...
            {/* FAQ*/}
            <div className={styles.home_faq} id="faq">
                <div className="faqContainer">
                    <div className={styles.home_faq1}>
                        <div className={styles.home_container7}>
                            <span className="overline">
                                <span>FAQ</span>
                                <br></br>
                            </span>
                            <h2 className={`${styles.home_text54} heading2`}>Common questions</h2>
                            <span className={`${styles.home_text55} bodyLarge`}>
                                <span>
                        ...
                        <div className={styles.home_container8}>
                            <QuestionCard
            ...
            <div className={styles.home_footer}>
                <footer className={`${styles.home_footer1} footerContainer`}>
                    <footer className={styles.home_footer2}>
                        <img
                            alt="logo"
                            src="https://avatars.githubusercontent.com/u/39369597"
                            className={styles.home_image1}
                        />
                        <span className={styles.home_text58}>
                            © 2024 <a href="https://github.com/saivishnu725">The Unconcerned Ape</a>, Made with love.
                        </span>
                        <div className={styles.home_icon_group1}>
                            ...
                            <a href="https://instagram.com/_sai.vishnu_">
                                <svg
                                    viewBox="0 0 877.7142857142857 1024"
                                    className={`${styles.home_icon12} socialIcons`}
                                >
                                    <path d="M585.143 512c0-80.571-65.714-146.286-146.286-146.286s-146.286 65.714-146.286 146.286 65.714 146.286 146.286 146.286 146.286-65.714 146.286-146.286zM664 512c0 124.571-100.571 225.143-225.143 225.143s-225.143-100.571-225.143-225.143 100.571-225.143 225.143-225.143 225.143 100.571 225.143 225.143zM725.714 277.714c0 29.143-23.429 52.571-52.571 52.571s-52.571-23.429-52.571-52.571 23.429-52.571 52.571-52.571 52.571 23.429 52.571 52.571zM438.857 152c-64 0-201.143-5.143-258.857 17.714-20 8-34.857 17.714-50.286 33.143s-25.143 30.286-33.143 50.286c-22.857 57.714-17.714 194.857-17.714 258.857s-5.143 201.143 17.714 258.857c8 20 17.714 34.857 33.143 50.286s30.286 25.143 50.286 33.143c57.714 22.857 194.857 17.714 258.857 17.714s201.143 5.143 258.857-17.714c20-8 34.857-17.714 50.286-33.143s25.143-30.286 33.143-50.286c22.857-57.714 17.714-194.857 17.714-258.857s5.143-201.143-17.714-258.857c-8-20-17.714-34.857-33.143-50.286s-30.286-25.143-50.286-33.143c-57.714-22.857-194.857-17.714-258.857-17.714zM877.714 512c0 60.571 0.571 120.571-2.857 181.143-3.429 70.286-19.429 132.571-70.857 184s-113.714 67.429-184 70.857c-60.571 3.429-120.571 2.857-181.143 2.857s-120.571 0.571-181.143-2.857c-70.286-3.429-132.571-19.429-184-70.857s-67.429-113.714-70.857-184c-3.429-60.571-2.857-120.571-2.857-181.143s-0.571-120.571 2.857-181.143c3.429-70.286 19.429-132.571 70.857-184s113.714-67.429 184-70.857c60.571-3.429 120.571-2.857 181.143-2.857s120.571-0.571 181.143 2.857c70.286 3.429 132.571 19.429 184 70.857s67.429 113.714 70.857 184c3.429 60.571 2.857 120.571 2.857 181.143z"></path>
                                </svg>
                            </a>
